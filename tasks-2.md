...
> Например, можно сопоставить символы с их **позициями первого вхождения** или использовать `str.maketrans`, но предложенный способ — один из самых **понятных и надёжных**.
